...
def train(batch_size = 100, max_iterations = 500, load_model_name = None):
    ...
    if load_model_name == '':
        ...
        res = frame.load_model(network = network, file_name = load_model_name, path = 'models', )
...
if __name__ == '__main__':
    train(batch_size = 100, load_model_name = '', )
