...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec  4 23:46:07 2018
...
class Unpool2DLayer(layers.Layer):
    ...
    def __init__(self, incoming, kernel_size, nonlinearity = lasagne.nonlinearities.linear, **kwargs):
        ...
        # kernel_size = stride and kernel is square for simplicity, and kernel_size must be int
...
class GreyscaleLayer(layers.Layer):
    ...
    '''
    def __init__(self, incoming, random_greyscale = False, random_seed = 42, **kwargs):
        '''
    ...
    def get_output_for(self, input, deterministic_greyscale = False, **kwargs):
        '''
        deterministic_greyscale is designed to allow using deterministic greyscale during validation
        '''
